...
import { BriefcaseIcon, CalendarIcon, ClockIcon, ChevronDownIcon, PencilIcon, TrashIcon } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/2 flex -translate-x-1/2 translate-y-1/2">
        <button className="bg-blue-500 text-white focus:outline-none p-2 rounded-full shadow-md mx-3">
          <PencilIcon className="h-5 w-5" />
        </button>
        <button className="bg-red-500 text-white focus:outline-none p-2 rounded-full shadow-md mx-3">
